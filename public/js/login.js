...
$('email').addEventListener('blur' , function() {   // e.target    "e" es un objeto y desestructuramos de ese objeto {target}
...
$('pass').addEventListener('blur' , function() {   // e.target    "e" es un objeto y desestructuramos de ese objeto {target}
...
$('form-login').addEventListener('submit' , (e) => {
    ...
    let elements = e.target.elements // Del formulario voy a acceder a sus elementos 
    let error = false
